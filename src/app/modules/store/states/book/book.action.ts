...
export const setSelectedBookIdAction = createAction(BookActionType.SET_BOOKS_BY_ID, props<{ id: string }>())
export const modifyOneBookAction = createAction(BookActionType.MODIFY_ONE_BOOK, props<{ book: Book }>());
export const setBooksByIdAction = createAction(BookActionType.SET_BOOKS_BY_ID, props<{ bookIds: string[] }>())
